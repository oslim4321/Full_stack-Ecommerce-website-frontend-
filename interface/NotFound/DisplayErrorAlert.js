...
function DisplayErrorAlert({ type, msg, removeAlert }) {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className={`top-0 z-50 fixed max-w-xs bg-${type}-800 text-sm text-white rounded-md shadow-lg dark:bg-gray-900 mb-3 ml-3 ml-3 w-[100%]`} role="alert">
        <div className="flex p-4">
          ...
          <div className="ml-auto">
            <button type="button" className="inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-md text-white/[.5] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-gray-600 transition-all text-sm dark:focus:ring-offset-gray-900 dark:focus:ring-gray-800">
              ...
              <svg onClick={() => removeAlert()} className="w-3.5 h-3.5" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
